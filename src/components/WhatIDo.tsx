      ...
      <div className="what-box">
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>BACKEND & CLOUD</h3>
              <h4>Scalable Architecture & DevOps</h4>
              <p>
                Building robust APIs, cloud-native solutions, and automated
                infrastructure. From MERN Stack to Python frameworks, with
                DevOps pipelines and cybersecurity awareness baked in.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
